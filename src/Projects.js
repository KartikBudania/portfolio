        ...
        <section id="work">
            ...
            <div className="projects">
                <div className="project">
                    ...
                    <h3><a href="https://kartikbudania.github.io/Harmony/" target="_blank">Visit the site <i className="fa-solid fa-link"></i></a></h3>
                    <h3><a href="https://github.com/KartikBudania/Harmony" target="_blank">See the code <i className="fa-brands fa-github"></i></a></h3>
                </div>
                <div className="project">
