        ...
        <section id="work">
            ...
            <div className="projects">
                <div className="project">
                    <a href="https://github.com/KartikBudania/Harmony" target="_blank"><img src={harmony} id="firstimg"></img></a>
                    <h2>// Harmony - The Music Player</h2>
                    <h3>This music player is a web-based application that allows users to stream and listen to their favorite songs and music playlists from anywhere, at any time. It provides a user-friendly interface that is easy to navigate and supports multiple audio formats.</h3>
                    <h2>// Tech Stack</h2>
                    <ul className="stacks">
                    ...
                    <h3><a href="https://kartikbudania.github.io/Code-Editor/" target="_blank">Visit Site <i className="fa-solid fa-link visit-site"></i></a><a href="https://github.com/KartikBudania/Code-Editor" target="_blank">See the code <i className="fa-brands fa-github"></i></a></h3>
                </div>
                <div className="project">
                    <a href="https://github.com/KartikBudania/Code-Editor" target="_blank"><img src={codeEditor}></img></a>
                ...
                <div className="project">
                    <a href="https://github.com/KartikBudania/Color-Picker" target="_blank"><img src={colorPicker}></img></a>
                ...
                <div className="project">
                    <a href="https://github.com/KartikBudania/My-Portfolio" target="_blank"><img src={portfolio}></img></a>
